...
source("https://raw.githubusercontent.com/RS-eco/traitdata/master/R/standardize_taxonomy.R")
source("https://raw.githubusercontent.com/RS-eco/traitdata/master/R/get_taxonomy.R")

...
#' HydroRivers data was downloaded from: https://www.hydrosheds.org/page/hydrorivers

# Load library
library(sf)

# Set filedir
filedir <- "/home/matt/Documents/Hydrosheds"

# Get Hydrosheds data
hydrorivers <- sf::st_read(paste0(filedir, "/HydroRIVERS_v10_eu.shp"))
...
# Hydrolakes data was downloaded from: https://www.hydrosheds.org/page/hydrolakes

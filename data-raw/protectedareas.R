...
# Set file directory
filedir <- "/home/matt/Documents/WDPA"

# Download PAs of Germany
#download.file("https://d1gam3xoknrgr2.cloudfront.net/current/WDPA_WDOECM_Apr2022_Public_DEU_shp.zip",
#              destfile=paste0(filedir, "/WDPA_WDOECM_Apr2022_Public_DEU_shp.zip"))
#download.file("https://d1gam3xoknrgr2.cloudfront.net/current/WDPA_WDOECM_Apr2022_Public_AUT_shp.zip",
#              destfile=paste0(filedir, "/WDPA_WDOECM_Apr2022_Public_AUT_shp.zip"))
#download.file("https://d1gam3xoknrgr2.cloudfront.net/current/WDPA_WDOECM_Apr2022_Public_CZE_shp.zip",
#              destfile=paste0(filedir, "/WDPA_WDOECM_Apr2022_Public_CZE_shp.zip"))
...
# Unzip shapefile
#unzip(paste0(filedir, "/WDPA_WDOECM_Apr2022_Public_DEU_shp.zip"), exdir = filedir)

# Read PA file
pa_deu_poly <- sf::st_read(dsn=paste0(filedir, "/WDPA_Jan2020_DEU-shapefile-polygons.shp"))
pa_deu_point <- sf::st_read(dsn=paste0(filedir, "/WDPA_Jan2020_DEU-shapefile-points.shp"))
pa_deu_poly1 <- sf::st_read(dsn=paste0(filedir, "/WDPA_Jan2020_DEU-shapefile-polygons.shp"))
pa_deu_point1 <- sf::st_read(dsn=paste0(filedir, "/WDPA_Jan2020_DEU-shapefile-points.shp"))
pa_deu_poly2 <- sf::st_read(dsn=paste0(filedir, "/WDPA_Jan2020_DEU-shapefile-polygons.shp"))
pa_deu_point2 <- sf::st_read(dsn=paste0(filedir, "/WDPA_Jan2020_DEU-shapefile-points.shp"))

...
#  library(bavDC); library(dplyr); library(sf); library(ggplot2); library(tidyr)
#  
...
## ----pa-cormat, fig.width=6, fig.height=5-------------------------------------
...
#                                            "Not Applicable", "Not Reported", "Total"))
#  
#  pa_bav_tk4tel <- pa_bav_tk4tel %>% filter(var == "perc_cov") %>% dplyr::select(-var)

...
knitr::opts_chunk$set(
  ...
  eval=T, echo=T, error=F, comment = "#>", fig.path="../figures/"
)
```
...
```{r pa-cormat, fig.width=6, fig.height=5}
...
```{r pa-dist, fig.width=6, fig.height=6}
...
```{r pa-map_eng, fig.width=8, fig.height=6}
data("pa_bav")
...
```{r pa-map_eng_sub, fig.width=7, fig.height=8}
...
```{r pa-map_deu_sub, fig.width=8, fig.height=8}

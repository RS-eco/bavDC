...
dwd_tmean <- dwd_yearmon_tadmm_bav_tk4tel %>%  
  tidyr::pivot_longer(cols=-c(x,y), names_to="date", values_to="tmean") %>%
...
all_tmean$Dataset <- factor(all_tmean$Dataset, 
                            levels=c("baywrf", "e-obs", "euro-cordex", "wfde5", "dwd"))
...
all_pr$Dataset <- factor(all_pr$Dataset, levels=c("baywrf", "e-obs", "euro-cordex", "wfde5", "dwd"))
